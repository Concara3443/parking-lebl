"""occupied_dialog.py — Occupied stands panel dialog for ParkingApp."""
...
def open(app):
    """Open (or raise) the occupied stands panel window."""
    ...
    _btn(bar, "⟳ Refresh", lambda: refresh(app),
         bg='#0a2a1a').pack(fill=tk.X, pady=(0, 4))
    _btn(bar, "x Liberar…", app._release_dialog,
